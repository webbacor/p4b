...
<div id="editChapter">
  ...
  <br />
    <form  action="index.php?action=editChapter" method="post" name="formulaire" id="formulaire"enctype="multipart/form-data">
  
    <input type="text" class="form-control" name="title" value="<?= $chapter['title']; ?>" required />
    <br /><br />
    <textarea id="tiny_mce"  name="content" rows="50"><?= $chapter['content']; ?></textarea>
    <br /><br />  

...
<html>
  <head>
    ...
    tinyMCE.init({
      ...
      /*les outils à afficher  SELON DEMANDE DE L'ECRIVAIN
      ...
      content_css : " public/tiny_mce/design-tiny.css,", 
      // taille disponible
        ...
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              <li><a href="index.php?action=indexAdmin" style="color:white">Accueil</a></li>
              <li><a href="index.php" style="color:white"> Deconnexion</a></li>
            </ul>
          </div>
        </nav>          
      </section> 
